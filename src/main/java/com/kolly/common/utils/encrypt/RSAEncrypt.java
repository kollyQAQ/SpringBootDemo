...
public class RSAEncrypt {
	...
	public static void main(String[] args) throws Exception {
		...
		////私钥解密过程
		//byte[] res=RSAEncrypt.decrypt(RSAEncrypt.loadPrivateKeyByStr(RSAEncrypt.loadPrivateKeyByFile(filepath)), Base64Utils.decodeFromString(cipher));
		...
		////公钥解密过程
		//res=RSAEncrypt.decrypt(RSAEncrypt.loadPublicKeyByStr(RSAEncrypt.loadPublicKeyByFile(filepath)), Base64Utils.decodeFromString(cipher));
		...
		map.put("requestNo", "JL123456789");
		map.put("version", "V1.0");
		map.put("productId", "1001");
		map.put("transId", "10");
		map.put("merNo", "8800345000221");
		map.put("orderDate", "20170808");
		map.put("orderNo", "JL123456789");
		map.put("returnUrl", "http://lpay.topfreeweb.net/Ldpay/reback");
		map.put("notifyUrl", "http://lpay.topfreeweb.net/Ldpay/renotify");
